...
from RandAugment import RandAugment, Lighting
import model_utils
import dataset
import train_utils
...
parser.add_argument('--task-name', default='propaganda_binary', type=str, help='name of the task')
...
parser.add_argument('--file-type', default='csv', type=str, help='file format: csv, jsonl')
...
def main():
    ...
    image_datasets = {
        'train': dataset.TaskDataset(train_path, args.task_name, sep, data_dir,args.file_type, data_transforms['train']),
        'val': dataset.TaskDataset(dev_path, args.task_name, sep, data_dir, args.file_type, data_transforms['val'])}
    ...
    if args.test:
        ...
        test_dataset = dataset.TaskDataset(args.test, args.task_name, sep, data_dir,args.file_type, test_transforms)
